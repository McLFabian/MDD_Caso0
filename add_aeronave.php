...
$aeronave->insert($id,$capacidad,$origen,$destino,1,$hora_origen,$hora_destino);
echo "<div class='alert alert-success'><a href='#' class='alert-link'>La Aeronave ha sido agregada exitosamente.</a></div><p><a href='index.php'>Volver</a></p>"; 
