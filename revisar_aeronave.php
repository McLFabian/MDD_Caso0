		        ...
		        <div class="content">
			   		...
			   		<ul class="articles">
						<li>
							<div>
								<span>Kalos</span> 
								<h2>Suenos y aventuras!</h2>  
							</div>
							<p><img src="images/regiones-kalos.png" width="300" height="197" alt="Kalos" title="Kalos"></p>
							<p>
								Kalos es la region del mundo Pokemon donde se desarrolla la trama de los videojuegos XY, de la sexta generacion. La region esta basada en Francia y su ciudad principal es Luminalia, cuya inspiracion en Paris se aprecia sobre todo en la Torre Prisma, monumento semejante a la Torre Eiffel. Kalos presenta la mayor poblacion de cualquier region, asi como la variedad mas amplia de especies Pokemon, que proceden de todo el mundo. Tal es asi que su Pokedex regional la divide en tres partes: Kalos Centro, Kalos Costa y Kalos Montana.
								Los entrenadores Pokemon que empiezan su aventura en esta region pueden elegir entre los Pokemon iniciales, Chespin, Fennekin y Froakie. Ademas, en Kalos se originaron las megaevoluciones, que permiten a los Pokemon, cuando ya no pueden evolucionar mas o que no tienen evolucion, acceder a una forma mas poderosa. En cuanto a los Pokemon legendarios, Xerneas e Yveltal guardan una profunda relacion con el territorio, que la organizacion criminal de la region, el Team Flare, trata de explotar.
								Como ya sucediera con Teselia, la numeracion de sus rutas parte del numero uno, ignorando las rutas presentes en otras regiones. Esto se puede atribuir, en el universo de Pokemon, a que la region se encuentra a gran distancia de las demas. <a href="http://es.pokemon.wikia.com/wiki/Kalos">Visita WIKIDEX para mas.</a>
							</p>
